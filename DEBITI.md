...
| Data | Scorciatoia | Perché rimandata | Quando si salda |
|---|---|---|---|
| 2026-09-20 | CLAUDE.md va diviso: regole universali vs regole dell'hub-in-quanto-hub (la regola «repo pubblico» copiata in repo private è dannosa: 77% dei riferimenti pendenti nel cliente) | report BusinessPlan, misura riprodotta | al prossimo giro di sync-repo (revisione 10 giri: tocca le regole vincolanti — decisione di Luca) |

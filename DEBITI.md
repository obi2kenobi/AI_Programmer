...
| Data | Scorciatoia | Perché rimandata | Quando si salda |
|---|---|---|---|
| 2026-09-20 | Le PR del solver (`night/issue-N`, titolo non `caccia:`) non hanno censore: il revisore le rinvia «non mio» a ogni ciclo, il morning gate le giudica solo dal Mac — PREMESSA CAMBIATA (revisione 10 giri, 2026-09-23): il morning-gate e' in pensione da launchd, quindi oggi queste PR non hanno NESSUN giudice automatico; inoltre fino a oggi una PR di issue in testa alla lista affamava il censore (curato: lib.sh candidata_censore) | il censore e' nato per le migliorie della caccia; estenderlo alle PR delle issue e' una decisione di Luca (il patto «il si' e' del censore» vale solo per la caccia) | quando Luca decide se le PR delle issue possono essere deliberate di notte |
| 2026-09-20 | 9 dei 15 percorsi citati nel CLAUDE.md installato non esistono nella destinazione (PROJECT.md, SAL.md, docs/system.md, llm/, night-shift/…): sono cose dell'hub, non della repo | la cura giusta e' nel CLAUDE.md (dire «nell'hub» accanto ai percorsi dell'hub), non copiare mezzo hub in ogni repo | al prossimo giro sul CLAUDE.md portabile (revisione 10 giri: tocca le regole vincolanti — decisione di Luca, insieme alla divisione del CLAUDE.md) |

...
| REPO-K | dashboard web GAS+BC per gestione ordini multi-categoria (SD) | dossier 86+25 (2026-08-28, TUTTI implementati); 2ª sessione 2026-08-31 (5 bug + tooltip + 4 feature, clasp in produzione); 3ª sessione 2026-09-01: 3 giri extra onesti (i rilievi calano ciclo dopo ciclo, dichiarato), clasp push ≠ PRODUZIONE scoperto e verificato col fetch mirato | docs/campo/2026-09-01-repo-k-terza-sessione-3-giri-extra-deploy.md |
...
| REPO-Q | Repo produzione/costi diretti GAS+BC, 8 sotto-progetti Apps Script indipendenti (bottom-up da distinta base, confronto col reale di produzione e con la contabilità), di cui 3 sono CLONI DI SOLA LETTURA di progetti sviluppati altrove (stesso scriptId di REPO-Sistema-Gestione-Magazzino, REPO-Golilla, REPO-Bilancio_periodico — mai onboardato allo standard di questo hub | 2026-09-01: audit di sola lettura su tutto il repo (mandato utente esplicito, non skill), 6 agenti paralleli → 53 rilievi reali (non i 200 richiesti — numero non gonfiato); 32 commit di fix (Tier1 8/8 bug +2 trovati in esecuzione incl. una funzione corrotta dallo stesso scrub secret che aveva rotto un altro progetto gemello, Tier2 17/17, Tier3 12/20, Tier4 3/8); PR mergiata; seguito stesso giorno con 3 idee aggiuntive dopo conferma esplicita dell'utente (AskUserQuestion su ambito e su quali voci). 2026-09-01/02: altri due cicli di tre giri su richiesta esplicita (giri 2-9, 78 rilievi aggiuntivi = 131 totali, incluso un rilievo di sicurezza severo — dashboard clienti pubblica con margini esposti, risolto per escalation esplicita con AskUserQuestion, non scelto in autonomia); PR #309 e #310 mergiate. **Incidente reale post-audit**: `clasp push` da REPO-Q (comando generato dall'agente senza verificare i confini "clone di sola lettura" già scritti in CLAUDE.md) ha sovrascritto il sorgente live di 2 dei 3 cloni (gas-magazzino, gas-contabilita), colpendo lavoro in corso la stessa notte in Sistema-Gestione-Magazzino/Bilancio_periodico — ripristinato ripushando dai cloni corretti; CLAUDE.md di REPO-Q rinforzato (nomi/scriptId espliciti, regola senza eccezioni) | docs/campo/2026-09-01-repo-q-audit-tutto-il-repo-53-voci.md, docs/campo/2026-09-02-repo-q-otto-giri-piu-incidente-clasp.md |

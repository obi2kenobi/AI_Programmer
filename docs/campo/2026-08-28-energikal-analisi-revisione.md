...
5.3 [BASSA] Match cliente Fornitore-N fragile (substring)
allegato-c-sheet.gs:82-85: isFornitore-N_ usa indexOf('BRICO') !== -1 — un futuro cliente con "BRICO" come sottostringa (es. "FABRICO SRL") verrebbe erroneamente incluso nell'Allegato C e nel calcolo pubblicità GDO.
...
La guida (§11.1) dichiara che il bilancino usa esclusivamente i saldi C/G perché "le fatture singole potrebbero non coprire il 100% del saldo". Ma la Pubblicità GDO (costi-engine.gs:161) si basa su fatturatoFornitore-N, calcolato sommando le righe vendita riconciliate (allegato-c-sheet.gs:145-163) — proprio la fonte che la guida segnala come potenzialmente incompleta — e non sottrae mai le NC vendita verso clienti Fornitore-N.

Nota dati: nel CSV Q4 2024 la Pubblicità GDO implica un fatturatoFornitore-N superiore al fatturato netto BIOC totale del trimestre — matematicamente impossibile con la regola "1,50% trimestrale" dichiarata, e coincide col trimestre con un "Premio clienti... solo Q4 annuale": suggerisce che nel 2024 questa voce fosse calcolata su base annuale/cumulativa, diversamente da guida e codice attuali.

...
col partner (Olsi/Innovio) — i documenti dell'integrazione per entrambi i repo, una
...
- **Il trigger a identità**: il primo giorno operativo, il log delle esecuzioni ha
  mostrato Vanessa autorizzata e idempotente (60/60 già presenti, zero doppioni) e il
  secondo trigger (Francesca) sì in lettura ma senza permesso sul registro — preso leggendo

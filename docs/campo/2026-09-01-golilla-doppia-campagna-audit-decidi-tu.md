# 2026-09-01 — Fornitore-N: due campagne di audit, "decidi tu su tutto", incidente Dashboard e post-mortem
...
completo in SAL.md §91 del repo Fornitore-N, guardia verificata (node --check riproduce il
...
REGISTRO.md non esiste in Fornitore-N, dichiarato). Nessun oracolo per le formule di

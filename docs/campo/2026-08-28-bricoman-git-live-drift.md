# 2026-08-28 — Fornitore-Nman, la deriva git↔live: misurarla prima di temerla
...
PR: repo `Gestione-ordini-Fornitore-Nman`, branch `claude/project-analysis-review-ryly0b`
(`#33` e `#34` mergiate).

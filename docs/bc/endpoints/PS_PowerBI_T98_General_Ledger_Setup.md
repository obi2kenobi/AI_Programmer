# Endpoint: `PS_PowerBI_T98_General_Ledger_Setup`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_T98_General_Ledger_Setup`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5OzM5OTU0ODE0MzY3ODUwMjU0NTYxOz... |  | ☐ |
| `Primary_Key` | string |  |  | ☐ |
...
| `Cust_Balances_Due` | float | 985234.62 |  | ☐ |
| `Date_Filter` | string |  |  | ☐ |
...
| `SEPA_Export_w_o_Bank_Acc_Data` | bool | False |  | ☐ |
| `SEPA_Non_Euro_Export` | bool | False |  | ☐ |

# Endpoint: `Spedizioni_vendita_registrate_Excel`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/Spedizioni_vendita_registrate_Excel`
...
| `PRJ_Ship_to_Name` | string | NICOLA LANCI |  | ☐ |
| `PRJ_Ship_to_Address` | string | FRANCELA,2 |  | ☐ |
| `PRJ_Ship_to_City` | string | Filetto |  | ☐ |

...
| `AppPublisher` | string | DATO-RIMOSSO S.p.A. |  | ☐ |
| `Published_As` | string |  PTE |  | ☐ |
| `AppIsInstalled` | bool | True |  | ☐ |
| `AllowHttpClientRequests` | bool | False |  | ☐ |
| `AppAllowsDebuggging` | bool | True |  | ☐ |
| `AppAllowsDownloadSource` | bool | False |  | ☐ |
| `AppAllowsDownloadSourceInSymbols` | bool | False |  | ☐ |
| `RepositoryUrl` | string |  |  | ☐ |
| `CommitId` | string |  |  | ☐ |
| `BuildBy` | string | AL Language Extension,15.0.1433841 |  | ☐ |
| `BuildUrl` | string |  |  | ☐ |

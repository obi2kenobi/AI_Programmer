# Endpoint: `PS_PowerBI_37_Sales_Lines`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_37_Sales_Lines`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE4Ozc1MzM5MDkxMTI1NDY0ODc2MzE7MD... |  | ☐ |
...
| `Amount_Including_VAT` | float | 21863.08 |  | ☐ |
...
| `Unit_Cost_LCY` | float | 407.753722222222 |  | ☐ |
| `Unit_Cost` | float | 407.753722222222 |  | ☐ |

...
- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/ItemCard`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5Ozg1ODYzODYxNjQ2OTM2ODE0NDAxOz... |  | ☐ |
| `No` | string | A0000000000000000001 |  | ☐ |
...
| `Family_Description_2` | string |  |  | ☐ |
| `Manufacturer_Code` | string |  |  | ☐ |
| `Service_Item_Group` | string |  |  | ☐ |
| `Automatic_Ext_Texts` | bool | False |  | ☐ |
| `Common_Item_No` | string |  |  | ☐ |
| `Purchasing_Code` | string |  |  | ☐ |
| `VariantMandatoryDefaultYes` | string | Default |  | ☐ |
| `VariantMandatoryDefaultNo` | string | Default |  | ☐ |
| `Service_Transaction_Type_Code` | string |  |  | ☐ |
| `Exclude_From_Service_Decl` | bool | False |  | ☐ |
| `Statistics_Group` | int | 0 |  | ☐ |
| `No_2` | string |  |  | ☐ |
| `Alternative_Item_No` | string |  |  | ☐ |
| `PRJ_Exclude_Quality_Control` | bool | False |  | ☐ |
| `Shelf_No` | string |  |  | ☐ |
| `Created_From_Nonstock_Item` | bool | False |  | ☐ |
| `Lifo_Category` | string |  |  | ☐ |
| `Inventory_Valuation` | string | Weighted Average |  | ☐ |
| `Search_Description` | string | ANUBE BRONZATE |  | ☐ |
| `Inventory` | float | 6245 |  | ☐ |
| `InventoryNonFoundation` | float | 6245 |  | ☐ |
| `Qty_on_Purch_Order` | float | 0 |  | ☐ |
| `Qty_on_Prod_Order` | float | 0 |  | ☐ |
| `Qty_on_Component_Lines` | float | 2623 |  | ☐ |
...
| `Net_Invoiced_Qty` | float | 6245 |  | ☐ |
| `Cost_is_Adjusted` | bool | True |  | ☐ |
| `Excluded_from_Cost_Adjustment` | bool | False |  | ☐ |
| `Cost_is_Posted_to_G_L` | bool | False |  | ☐ |
| `Inventory_Value_Zero` | bool | False |  | ☐ |
| `SpecialPurchPriceListTxt` | string | Create New... |  | ☐ |
| `SpecialPurchPricesAndDiscountsTxt` | string | View Existing Prices and Discounts... |  | ☐ |
...
| `Service_Commitment_Option` | string | No Subscription |  | ☐ |
| `Sales_Blocked` | bool | False |  | ☐ |
| `Service_Blocked` | bool | False |  | ☐ |
...
| `UsageDataSupplierRefExists` | bool | False |  | ☐ |
| `PRJ_Manufacturer_Item_No` | string |  |  | ☐ |
...
| `Reordering_Policy` | string | Lot-for-Lot |  | ☐ |
...
| `PRJ_Commission_Posting_Group` | string | ARRG |  | ☐ |

# Endpoint: `MovimentiValorizzazione`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/MovimentiValorizzazione`
...
| `Order_No` | string | 26OP-05286 |  | ☐ |
| `Valued_By_Average_Cost` | bool | False |  | ☐ |
| `Item_Ledger_Entry_No` | int | 213402 |  | ☐ |
| `Capacity_Ledger_Entry_No` | int | 0 |  | ☐ |
| `Job_No` | string |  |  | ☐ |
| `Job_Task_No` | string |  |  | ☐ |
| `Job_Ledger_Entry_No` | int | 0 |  | ☐ |
| `Dimension_Set_ID` | int | 3 |  | ☐ |
| `Shortcut_Dimension_3_Code` | string | 81 |  | ☐ |

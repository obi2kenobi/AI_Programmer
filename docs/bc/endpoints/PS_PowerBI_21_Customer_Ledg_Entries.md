# Endpoint: `PS_PowerBI_21_Customer_Ledg_Entries`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_21_Customer_Ledg_Entries`
...
| `Customer_Name` | string | SANGALLI VETRO PORTO NOGARO SPA |  | ☐ |
...
| `Sales_LCY` | float | 20788.41 |  | ☐ |
| `Salesperson_Code` | string |  |  | ☐ |
| `Sell_to_Customer_No` | string | 0002952 |  | ☐ |
| `Source_Code` | string |  |  | ☐ |

# Endpoint: `PS_PowerBI_111_Posted_Sales_Ship_Subform`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_111_Posted_Sales_Ship_Subform`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzIwOzE2NzU5NjMxMzc4NDA1NTA4ODYxMT... |  | ☐ |
| `Document_No` | string | 23SVR-000003 |  | ☐ |
| `Line_No` | int | 10000 |  | ☐ |
| `Type` | string | Item |  | ☐ |
...
| `Authorized_for_Credit_Card` | bool | False |  | ☐ |
...
| `Description` | string | Casetta SONDRIO |  | ☐ |
...
| `Item_Charge_Base_Amount` | float | 1253.28 |  | ☐ |
| `Item_Shpt_Entry_No` | int | 131642 |  | ☐ |
...
| `Planned_Delivery_Date` | string | 2025-07-21 |  | ☐ |
| `Planned_Shipment_Date` | string | 2025-07-21 |  | ☐ |

...
| `Created_DateTime` | datetime | 2023-06-01T12:56:00Z |  | ☐ |
...
| `E_Mail` | string | info@gruppocamarlinghi.it |  | ☐ |
| `Fax_No` | string | +39 0583 23710 |  | ☐ |
| `FD_Address` | string |  |  | ☐ |
| `FD_City` | string |  |  | ☐ |
| `FD_County` | string |  |  | ☐ |
| `FD_Post_Code` | string |  |  | ☐ |
...
| `Last_Modified_Date_Time` | datetime | 2026-01-19T14:21:09.357Z |  | ☐ |

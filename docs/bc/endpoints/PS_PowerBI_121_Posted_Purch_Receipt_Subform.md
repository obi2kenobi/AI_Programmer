# Endpoint: `PS_PowerBI_121_Posted_Purch_Receipt_Subform`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_121_Posted_Purch_Receipt_Subform`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5OzUyNzUyNTAzNjI5NTM4MTE4NTYxOz... |  | ☐ |
| `Document_No` | string | 24CAR-0000001 |  | ☐ |
| `Line_No` | int | 10000 |  | ☐ |
...
| `Description` | string | Manodopera manutenzione |  | ☐ |
| `Description_2` | string |  |  | ☐ |
| `Dimension_Set_ID` | int | 0 |  | ☐ |
| `Direct_Unit_Cost` | float | 42 |  | ☐ |
...
| `Gen_Prod_Posting_Group` | string | MANUTENZIONE |  | ☐ |
...
| `Item_Charge_Base_Amount` | float | 798 |  | ☐ |
| `Item_Rcpt_Entry_No` | int | 2236 |  | ☐ |
...
| `Planned_Receipt_Date` | date | 2024-01-08 |  | ☐ |
...
| `Type` | string | Item |  | ☐ |
| `Unit_Cost` | float | 42 |  | ☐ |
| `Unit_Cost_LCY` | float | 42 |  | ☐ |
| `Unit_Price_LCY` | float | 42 |  | ☐ |
| `Unit_Volume` | float | 0 |  | ☐ |

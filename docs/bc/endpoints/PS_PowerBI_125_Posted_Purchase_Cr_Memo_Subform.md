# Endpoint: `PS_PowerBI_125_Posted_Purchase_Cr_Memo_Subform`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_125_Posted_Purchase_Cr_Memo_Subform`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5OzE5MTQyNTgwMTQ4MTYxMTY2MDcxOz... |  | ☐ |
| `Document_No` | string | 24FAI-000026 |  | ☐ |
| `Line_No` | int | 10000 |  | ☐ |
| `Allow_Invoice_Disc` | bool | False |  | ☐ |
| `Amount` | float | 4.69 |  | ☐ |
| `Amount_Including_VAT` | float | 5.16 |  | ☐ |
...
| `Description` | string | Spese Acqua |  | ☐ |
| `Description_2` | string |  |  | ☐ |
| `Dimension_Set_ID` | int | 35 |  | ☐ |

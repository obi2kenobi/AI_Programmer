# Endpoint: `Riferimenti_articolo`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/Riferimenti_articolo`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzIwOzE2OTQyMTE5NTUwNDQ3OTYxMjE2MT... |  | ☐ |
| `Item_No` | string | A0000000000000000001 |  | ☐ |
| `Variant_Code` | string |  |  | ☐ |
| `Unit_of_Measure` | string | PZ |  | ☐ |
| `Reference_Type` | string | Vendor |  | ☐ |
| `Reference_Type_No` | string | 0000684 |  | ☐ |

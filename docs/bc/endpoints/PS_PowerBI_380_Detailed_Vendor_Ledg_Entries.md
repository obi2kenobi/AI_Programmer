# Endpoint: `PS_PowerBI_380_Detailed_Vendor_Ledg_Entries`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_380_Detailed_Vendor_Ledg_Entries`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5Ozg4ODcyMTYwMzUyMTg4Njc1ODMxOz... |  | ☐ |
| `Entry_No` | int | 1 |  | ☐ |
| `Amount` | float | -6754.61 |  | ☐ |
| `Amount_LCY` | float | -6754.61 |  | ☐ |
| `Application_No` | int | 0 |  | ☐ |

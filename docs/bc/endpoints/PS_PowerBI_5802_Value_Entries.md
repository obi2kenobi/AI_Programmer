# Endpoint: `PS_PowerBI_5802_Value_Entries`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_5802_Value_Entries`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzIwOzE1NjY5NzE5OTM4OTYwOTc0MjY4MT... |  | ☐ |
| `Entry_No` | int | 1 |  | ☐ |
| `Adjustment` | bool | False |  | ☐ |
| `Applies_to_Entry` | int | 0 |  | ☐ |
...
| `Job_No` | string |  |  | ☐ |
| `Job_Task_No` | string |  |  | ☐ |
| `Journal_Batch_Name` | string | INVENTARIO |  | ☐ |

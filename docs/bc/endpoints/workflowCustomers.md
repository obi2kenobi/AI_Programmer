# Endpoint: `workflowCustomers`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/workflowCustomers`
...
| `city` | string | Budoni |  | ☐ |
| `contact` | string |  |  | ☐ |
| `phoneNumber` | string | 338 9470008 |  | ☐ |
| `telexNumber` | string |  |  | ☐ |
...
| `numberOfInvoices` | int | 0 |  | ☐ |
| `numberOfReturnOrders` | int | 0 |  | ☐ |
| `numberOfCreditMemos` | int | 0 |  | ☐ |
| `numberOfPstdShipments` | int | 0 |  | ☐ |
| `numberOfPstdInvoices` | int | 0 |  | ☐ |
| `numberOfPstdReturnReceipts` | int | 0 |  | ☐ |
| `numberOfPstdCreditMemos` | int | 0 |  | ☐ |
| `numberOfShipToAddresses` | int | 0 |  | ☐ |
| `billToNumberOfQuotes` | int | 0 |  | ☐ |
| `billToNumberOfBlanketOrders` | int | 0 |  | ☐ |
| `billToNumberOfOrders` | int | 0 |  | ☐ |
| `billToNumberOfInvoices` | int | 0 |  | ☐ |
| `billToNumberOfReturnOrders` | int | 0 |  | ☐ |
| `billToNumberOfCreditMemos` | int | 0 |  | ☐ |
| `billToNumberOfPstdShipments` | int | 0 |  | ☐ |
| `billToNumberOfPstdInvoices` | int | 0 |  | ☐ |
| `billToNumberOfPstdReturnR` | int | 0 |  | ☐ |
| `billToNumberOfPstdCrMemos` | int | 0 |  | ☐ |

# Endpoint: `PS_PowerBI_115_Posted_Sales_Credit_Memo_Subform`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_115_Posted_Sales_Credit_Memo_Subform`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5OzY2NjI0MjkwMDMzNjU4MTk3OTAxOz... |  | ☐ |
| `Document_No` | string | 20FVI-000011 |  | ☐ |
| `Line_No` | int | 10000 |  | ☐ |
| `No` | string | CAS15ITACSP198X198 |  | ☐ |
...
| `Description` | string | CASETTA BLK. 15 MM ITACA SP |  | ☐ |

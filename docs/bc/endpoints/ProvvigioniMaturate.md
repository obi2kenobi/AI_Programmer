# Endpoint: `ProvvigioniMaturate`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/ProvvigioniMaturate`
...
| `Type` | string | Item |  | ☐ |
| `No` | string | CAS201FALSPSMISURA |  | ☐ |
| `Variant_Code` | string |  |  | ☐ |
| `Description` | string | CASETTA PROFILI 20 MM SU MISURA SP |  | ☐ |
| `PRJ_Maturation_Type` | string | Invoicing |  | ☐ |
...
| `Mat_Commission_Amount_LCY` | float | 31.41 |  | ☐ |
| `Source_Document_No` | string | 24OV-000031 |  | ☐ |
| `Source_Document_Line_No` | int | 10000 |  | ☐ |

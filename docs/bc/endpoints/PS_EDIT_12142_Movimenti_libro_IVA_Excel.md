# Endpoint: `PS_EDIT_12142_Movimenti_libro_IVA_Excel`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_EDIT_12142_Movimenti_libro_IVA_Excel`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzIwOzEyNzcyNTI0OTQyOTQ5NDg5NDg5MT... |  | ☐ |
| `Entry_No` | int | 1 |  | ☐ |
...
| `Official_Date` | date | 2024-01-08 |  | ☐ |
| `Operation_Occurred_Date` | date | 2024-01-08 |  | ☐ |
| `Posting_Date` | date | 2024-01-08 |  | ☐ |
| `Printing_Date` | date | 2024-05-15 |  | ☐ |
| `Reverse_VAT_Entry` | bool | False |  | ☐ |
| `Sell_to_Buy_from_No` | string | 500046 |  | ☐ |

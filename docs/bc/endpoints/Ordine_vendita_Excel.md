# Endpoint: `Ordine_vendita_Excel`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/Ordine_vendita_Excel`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5OzIxODAwMDU4OTY2MzI4NTQzMzkxOz... |  | ☐ |
...
| `ShippingOptions` | string | Default (Sell-to Address) |  | ☐ |
...
| `Ship_to_Phone_No` | string | 0587/686094-5-6 |  | ☐ |
...
| `BillToOptions` | string | Default (Customer) |  | ☐ |
...
| `PRJ_Ship_to_Post_Code` | string |  |  | ☐ |
| `PRJ_Ship_to_County` | string |  |  | ☐ |
| `PRJ_Ship_to_Count_Reg_Code` | string |  |  | ☐ |
| `PRJ_Ship_to_E_Mail` | string |  |  | ☐ |
| `PRJ_Ship_to_Phone_No` | string |  |  | ☐ |
| `PRJ_Shipping_Add_Price_Group` | string | LMI |  | ☐ |

# Endpoint: `PS_PowerBI_38_Purchase_Header`

- URL: `https://api.businesscentral.dynamics.com/v2.0/4d4b10ed-d04a-455b-80e1-aaf7ba4ee0d8/Production/ODataV4/Company('GRUPPO%20CAMARLINGHI%20S.P.A')/PS_PowerBI_38_Purchase_Header`
...
|---|---|---|---|---|
| `@odata.etag` | string | W/"JzE5OzIzODY5MjM4NDQyNjExODYwMTIxOz... |  | ☐ |
| `Document_Type` | string | Quote |  | ☐ |
| `No` | string | 23OFFA-0000001 |  | ☐ |
...
| `Bank_Account` | string | 0310437830 |  | ☐ |
| `Birth_City` | string |  |  | ☐ |
| `Buy_from_Address` | string | Via Ayrton Senna 15-17-19 |  | ☐ |
| `Buy_from_Address_2` | string |  |  | ☐ |
| `Buy_from_City` | string | San Miniato |  | ☐ |
| `Buy_from_Contact` | string |  LUCA  |  | ☐ |
| `Buy_from_Contact_No` | string |  |  | ☐ |
| `Buy_from_Country_Region_Code` | string | IT |  | ☐ |
| `Buy_from_County` | string | PI |  | ☐ |
| `Buy_from_IC_Partner_Code` | string |  |  | ☐ |
| `Buy_from_Post_Code` | string | 56028 |  | ☐ |
| `Buy_from_Vendor_Name` | string | Tecnograf S.R.L. |  | ☐ |
| `Buy_from_Vendor_Name_2` | string |  |  | ☐ |
| `Buy_from_Vendor_No` | string | 0000166 |  | ☐ |
| `Campaign_No` | string |  |  | ☐ |
| `Check_Total` | int | 0 |  | ☐ |
| `Comment` | bool | False |  | ☐ |
...
| `Doc_No_Occurrence` | int | 1 |  | ☐ |
| `Document_Date` | string | 2023-12-28 |  | ☐ |
| `Due_Date` | string | 0001-01-01 |  | ☐ |
| `Entry_Point` | string |  |  | ☐ |
| `Expected_Receipt_Date` | string | 0001-01-01 |  | ☐ |
| `First_Name` | string |  |  | ☐ |
| `Fiscal_Code` | string | 04228360485 |  | ☐ |
| `Gen_Bus_Posting_Group` | string | FOR_NAZ |  | ☐ |
| `IC_Direction` | string | Outgoing |  | ☐ |
| `IC_Status` | string | New |  | ☐ |
| `Inbound_Whse_Handling_Time` | string |  |  | ☐ |
| `Incoming_Document_Entry_No` | int | 0 |  | ☐ |
| `Individual_Person` | bool | False |  | ☐ |
| `Invoice` | bool | False |  | ☐ |
| `Invoice_Disc_Code` | string | 0000166 |  | ☐ |
| `Invoice_Discount_Amount` | int | 0 |  | ☐ |
| `Invoice_Discount_Calculation` | string | None |  | ☐ |
| `Invoice_Discount_Value` | int | 0 |  | ☐ |
| `Job_Queue_Entry_ID` | string | 00000000-0000-0000-0000-000000000000 |  | ☐ |
| `Job_Queue_Status` | string |   |  | ☐ |
| `Language_Code` | string | ITA |  | ☐ |
| `Last_Name` | string |  |  | ☐ |
| `Last_Posting_No` | string |  |  | ☐ |
| `Last_Prepayment_No` | string |  |  | ☐ |
| `Last_Prepmt_Cr_Memo_No` | string |  |  | ☐ |
| `Last_Receiving_No` | string | 24CAR-0000137 |  | ☐ |
| `Last_Return_Shipment_No` | string |  |  | ☐ |
| `Lead_Time_Calculation` | string |  |  | ☐ |
| `Location_Code` | string | PRINCIPALE |  | ☐ |
| `Location_Filter` | string |  |  | ☐ |
| `No_Printed` | int | 0 |  | ☐ |
| `No_Series` | string | A-OFFER |  | ☐ |
| `No_of_Archived_Versions` | int | 0 |  | ☐ |
| `On_Hold` | string |  |  | ☐ |
| `Operation_Occurred_Date` | string | 2023-12-28 |  | ☐ |
| `Operation_Type` | string | FT-ACQ-IT+ |  | ☐ |
| `Order_Address_Code` | string |  |  | ☐ |
| `Order_Class` | string |  |  | ☐ |
| `Order_Date` | string | 2023-12-28 |  | ☐ |
| `Partially_Invoiced` | bool | False |  | ☐ |
| `Pay_to_Address` | string | Via Ayrton Senna 15-17-19 |  | ☐ |
| `Pay_to_Address_2` | string |  |  | ☐ |
| `Pay_to_City` | string | San Miniato |  | ☐ |
| `Pay_to_Contact` | string |  LUCA  |  | ☐ |
| `Pay_to_Contact_No` | string |  |  | ☐ |
| `Pay_to_Country_Region_Code` | string | IT |  | ☐ |
| `Pay_to_County` | string | PI |  | ☐ |
| `Pay_to_IC_Partner_Code` | string |  |  | ☐ |
| `Pay_to_Name` | string | Tecnograf S.R.L. |  | ☐ |
| `Pay_to_Name_2` | string |  |  | ☐ |
| `Pay_to_Post_Code` | string | 56028 |  | ☐ |
| `Pay_to_Vendor_No` | string | 0000166 |  | ☐ |
| `Payment_Percent` | int | 100 |  | ☐ |
| `Payment_Discount_Percent` | int | 0 |  | ☐ |
| `Payment_Method_Code` | string | RIBA |  | ☐ |
| `Payment_Reference` | string |  |  | ☐ |
| `Payment_Terms_Code` | string | 120FM15 |  | ☐ |
| `Pending_Approvals` | int | 0 |  | ☐ |
| `Pmt_Discount_Date` | string | 0001-01-01 |  | ☐ |
| `Posting_Date` | string | 0001-01-01 |  | ☐ |
| `Posting_Description` | string | Offerta 23OFFA-0000001 |  | ☐ |
| `Posting_No` | string |  |  | ☐ |
...
| `Print_Posted_Documents` | bool | False |  | ☐ |
...
| `Return_Shipment_No_Series` | string |  |  | ☐ |
| `Reverse_Sales_VAT_No` | string |  |  | ☐ |
| `Reverse_Sales_VAT_No_Series` | string |  |  | ☐ |
| `Sell_to_Customer_No` | string |  |  | ☐ |
| `Send_IC_Document` | bool | False |  | ☐ |
| `Service_Tariff_No` | string |  |  | ☐ |
| `Ship` | bool | False |  | ☐ |
| `Ship_to_Address` | string | Via della Repubblica, 340 |  | ☐ |
| `Ship_to_Address_2` | string |  |  | ☐ |
| `Ship_to_City` | string | Impianto |  | ☐ |
| `Ship_to_Code` | string |  |  | ☐ |
...
| `Subcontracting_Order` | bool | False |  | ☐ |
| `TDD_Prepared_By` | string |  |  | ☐ |
...
| `VAT_Registration_No` | string | 04228360485 |  | ☐ |
| `Vendor_Authorization_No` | string |  |  | ☐ |
| `Vendor_Cr_Memo_No` | string |  |  | ☐ |
| `Vendor_Invoice_No` | string |  |  | ☐ |
| `Vendor_Order_No` | string |  |  | ☐ |
| `Vendor_Posting_Group` | string | FOR_NAZ |  | ☐ |
| `Vendor_Shipment_No` | string | 5142907806 |  | ☐ |

...
def main():
    ...
    lines = [
        ...
        # (2026-09-24, sesto ventaglio, S1 R4): i commenti in riga nel blocco (CLAUDE.md §3) si leggono come testo
        # in zsh senza interactive_comments: la spiegazione sta sopra, in prosa
